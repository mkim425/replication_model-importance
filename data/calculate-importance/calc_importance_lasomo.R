...
source(paste0(path,"/data/calculate-importance/importance_score_lasomo.R"))
source(paste0(path,"/data/calculate-importance/build_array_lasomo.R"))
...
build_array_lasomo(forecast_data, truth) 
